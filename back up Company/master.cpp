...
Master::Master(const char * _name, const char * _address, const char * _EGN, const Date& _date, Employee * _boss, const char * _position, const char* _nameOfCurrentProject, const char * _nameOfTestedProject, const char * _OS)
	:Employee(_name, _address, _EGN, _date, _boss)
{
	this->setPosition(_position);
	this->setNameOfCurrentProject(_nameOfCurrentProject);
