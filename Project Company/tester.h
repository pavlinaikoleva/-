...
public:
	Tester();
	Tester(const char * _name, const char * _address, const char * _EGN, const char *_date, Employee * _boss = nullptr, const char * _position = "junior tester", const char * _nameOfTestedProject = "",const char * _OS="");
	void print() const;
