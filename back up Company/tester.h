...
public:
	...
	Tester(const char * _name, const char * _address, const char * _EGN,const Date& _date, Employee * _boss = nullptr, const char * _position = "tester", const char * _nameOfTestedProject = "", const char * _OS = "");
	void print() const;
