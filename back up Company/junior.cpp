...
using std::endl;
Junior::Junior(){}
Junior::Junior(const char * _name, const char * _address, const char * _EGN, const char *_date, Employee * _boss, const char * _position,const char * _nameOfCurrentProject)
	:Employee(_name,_address,_EGN,_date,_boss)
{
	this->setPosition(_position);
	this->setNameOfCurrentProject(_nameOfCurrentProject);
}
Junior::Junior(const char * _name, const char * _address, const char * _EGN, const Date&_date, Employee * _boss, const char * _position, const char * _nameOfCurrentProject)
	: Employee(_name, _address, _EGN, _date, _boss)
{
	this->setPosition(_position);
	this->setNameOfCurrentProject(_nameOfCurrentProject);
